...
import { AlertCircle, CreditCard, Mail, SendIcon, StickerIcon } from 'lucide-vue-next';
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Integration Settings', href: route('organization.settings.integrations') },
];
...
const submit = () => {
  form.put(route('organization.settings.integrations.update', props.organization.uuid));
};
</script>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <SettingsLayout type="organization">
      ...
      <HeadingSmall
        ...
        description="Manage your organization's integrations with external services"
      />
      ...
      <form @submit.prevent="submit" class="space-y-8">
        ...
        <div class="space-y-6">
            ...
            <CardHeader>
              <div class="flex items-center justify-between">
                <div class="flex items-start gap-2">
                  <StickerIcon class="text-muted-foreground h-5 w-5" />
                  <div>
            ...
            <CardContent v-if="form.integrations.smtp.enabled">
              <div class="grid gap-4">
                <div class="grid gap-2">
                  ...
                  <Input id="smtp_host" v-model="form.integrations.smtp.host" type="text" />

                  <InputError :message="form.errors['integrations.smtp.host']" />
                </div>
                <div class="grid gap-2">
                  <Label for="smtp_port">Port</Label>
                  <Input id="smtp_port" v-model="form.integrations.smtp.port" type="number" />
                ...
                <div class="grid gap-2">
                  ...
                  <Input id="smtp_username" v-model="form.integrations.smtp.username" type="text" />

                  <InputError :message="form.errors['integrations.smtp.username']" />
                </div>
                <div class="grid gap-2">
                  <Label for="smtp_password">Password</Label>
                  <Input id="smtp_password" v-model="form.integrations.smtp.password" type="password" />

                  <InputError :message="form.errors['integrations.smtp.password']" />
                </div>
                <div class="grid gap-2">
                  <Label for="smtp_encryption">Encryption</Label>
                  <Select id="smtp_encryption" v-model="form.integrations.smtp.encryption">
                ...
                <div class="grid gap-2">
                  ...
                  <Input id="smtp_from_address" v-model="form.integrations.smtp.from_address" type="email" />

                  <InputError :message="form.errors['integrations.smtp.from_address']" />
                </div>
                <div class="grid gap-2">
                  <Label for="smtp_from_name">From Name</Label>
                  <Input id="smtp_from_name" v-model="form.integrations.smtp.from_name" type="text" />
          ...
          <Card>
            <CardHeader>
              <div class="flex items-center justify-between">
                <div class="flex items-start gap-2">
                  <SendIcon class="text-muted-foreground h-5 w-5" />
                  <div>
            ...
            <CardContent v-if="form.integrations.sendgrid.enabled">
              <div class="grid gap-4">
                <div class="grid gap-2">
                  ...
                  <Input id="sendgrid_api_key" v-model="form.integrations.sendgrid.api_key" placeholder="SG.xxxxxxx" type="password" />
            ...
            <CardContent v-if="form.integrations.mailgun.enabled">
              <div class="grid gap-4">
                <div class="grid gap-2">
                  ...
                  <Input id="mailgun_api_key" v-model="form.integrations.mailgun.api_key" type="password" />

                  <InputError :message="form.errors['integrations.mailgun.api_key']" />
                </div>
                <div class="grid gap-2">
                  <Label for="mailgun_domain">Domain</Label>
                  <Input id="mailgun_domain" v-model="form.integrations.mailgun.domain" type="text" />
        ...
        <div class="space-y-6">
          <h3 class="text-lg font-semibold">Payment Services</h3>
            ...
            <CardContent v-if="form.integrations.stripe.enabled">
              <div class="grid gap-4">
                <div class="grid gap-2">
                  ...
                  <Input id="stripe_public_key" v-model="form.integrations.stripe.public_key" type="text" />
                ...
                <div class="grid gap-2">
                  ...
                  <Input id="stripe_secret_key" v-model="form.integrations.stripe.secret_key" type="password" />
